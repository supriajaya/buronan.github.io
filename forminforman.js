document.addEventListener("DOMContentLoaded", function () {
  const target = document.getElementById("formInforman");
  if (!target) return;
  ...
  const css = `
    .form-kunci {
      ...
      z-index: 50; box-shadow: 0 2px 5px rgba(0,0,0,0.1);
    }
    body { padding-top: 300px; margin: 0; font-family: sans-serif; background: #f4f4f4; }
    input, textarea, button {
      width: 100%; margin: 8px 0; padding: 10px;
      font-size: 16px; border-radius: 6px; border: 1px solid #ccc; box-sizing: border-box;
    }
    .komentar {
    ...
    .balas-box { margin-top: 10px; }
    #preview {
      width: 100px; height: auto; margin-top: 5px;
    ...
    .gambar-float {
      ...
      width: 10vw; height: auto; z-index: 20;
  ...
  const html = `
    <img src="" class="gambar-float" onclick="showLogin()">
    <h3>INFO MASYARAKAT</h3>
    <h3>KASUS PENCURIAN, PENGGELAPAN, PEMERASAN, PENIPUAN</h3>
    <li>Ujang Chaerudin (Bekasi)</li>
    <li>Bagus Irwan Khalifi (Banten)</li>
    <input type="text" id="nama" placeholder="Nama Informan (Boleh Samaran)">
    <textarea id="informasi" placeholder="Tulis Informasi Disini ...."></textarea>
    ...
    <img id="ikonFloating2" src="https://buronan.site/ktp.jpg" onclick="fungsiKlik2()">
  `;
  ...
  window.kirim = function () {
    ...
    reader.onload = function (e) {
      ...
      fetch(URL, { method: 'POST', body: form })
        .then(res => res.json())
        .then(() => {
          alert("Terimakasih, Informasi anda sudah kami terima");
  ...
  window.fungsiKlik2 = function () {
    window.scrollTo({ top: 0, behavior: 'smooth' });
  };

  window.balasKomentar = function (waktu, textarea) {
